...
import { Star, Calendar, AlertTriangle, Camera } from 'lucide-react'
...
export function ClienteCard({ cliente, contratos, onClick, onFotoChange }: Props) {
  ...
  function handleFileChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    // Redimensionar para max 800px de largura antes de salvar em base64
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-28 bg-gradient-to-br from-slate-100 to-slate-200 overflow-hidden">
        ...
        {/* Botão de alterar foto — visível no hover */}
        {onFotoChange && (
          <button
